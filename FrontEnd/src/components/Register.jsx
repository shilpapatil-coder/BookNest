    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-black p-4">
            <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20 transform transition-all hover:scale-[1.02]">
                <h2 className="text-3xl font-extrabold text-white text-center mb-8 tracking-tight">Join BookNest</h2>
                ...
                <p className="mt-8 text-center text-sm text-purple-200">
                    Already have an account? <Link to="/login" className="font-bold text-white hover:text-purple-300 transition-colors">Sign in</Link>
                </p>
            </div>
        </div>
    );
